...
public class ScoreTrackingActivity extends Activity implements ScoreTrackingInteractionInterface, ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roundId = intent.getIntExtra(MainActivity.ROUND_ID, 1);
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(final int i) {
                ...
                ScoreFragmentInterface fragment = (ScoreFragmentInterface) mSectionsPagerAdapter.instantiateItem(mViewPager, i);
                if (fragment != null) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return ScoringHoleFragment.newInstance(position+1);
        ...
        public int getCount() {
            // Show 3 total pages.
            return getHolesByCourseId(getRound(roundId).getCourseId()).size();
        }

        @Override
        public CharSequence getPageTitle(int position) {
               return "Hole " + getHolesByCourseId(getRound(roundId).getCourseId()).get(position).getHoleId();
        }
    }
